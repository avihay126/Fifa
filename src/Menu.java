...
public class Menu extends JPanel {
    ...
    public Menu(int x, int y, int width, int height) {
        ...
        this.newGame = addButton(font, "New Game", this.getWidth() / 2 - BUTTON_WIDTH / 2, (int) (this.getHeight() - BUTTON_HEIGHT * BUTTON_Y_DIRECTION), BUTTON_WIDTH, BUTTON_HEIGHT);
        this.rulesOfGame = addButton(font, "Game Rules", this.getWidth() / 2 - BUTTON_WIDTH / 2, (int) (this.getHeight() - BUTTON_HEIGHT * (BUTTON_Y_DIRECTION - 1)), BUTTON_WIDTH, BUTTON_HEIGHT);
        buttonsListener();
