...
public class GameScene extends JPanel {
    ...
    public GameScene(int x, int y, int width, int height, JButton menuNewGame, JButton menuGameRule) {
        ...
        this.exit= Helper.addButton(this,null, "Exit", Stadium.BOUND_X + Stadium.BOUND_WIDTH - EXIT_WIDTH, Stadium.BOUND_Y + Stadium.BOUND_HEIGHT - EXIT_HEIGHT, EXIT_WIDTH, EXIT_HEIGHT);
